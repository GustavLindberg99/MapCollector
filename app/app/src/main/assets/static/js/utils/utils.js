...
typechecked.add(Multiline, Point, Segment);
...
deviceIsMobile = typechecked(deviceIsMobile);
 ...
 */
export function multilineFromPoints(points /*: Array<Point> */) /*: Multiline */ {
    if(points.length < 2){
...
multilineFromPoints = typechecked(multilineFromPoints);
...
getEaster = typechecked(getEaster);