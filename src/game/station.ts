    ...
    textBox(): Box {
        if(this.#cachedTextBox === null){
            ...
            case Station.Alignment.Bottom:
                ...
                break;
            default:
                throw new TypeError("Unknown station alignment");
            }
...
namespace Station {
    ...
    export class Alignment {
        ...
        static readonly Right = new this("start");
        static readonly Left = new this("end");
        static readonly Top = new this("middle");
        static readonly Bottom = new this("middle");
        static readonly Invisible = new this("");

        /**
         * Private constructor as this class is enum-like.
         *
         * @param textAnchor    A string that can be used in the text-anchor SVG attribute.
         */
        private constructor(textAnchor: string){
