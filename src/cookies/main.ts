...
function acceptCookies(event: Event): void {
    ...
    const cookieConsent = (event.currentTarget as Node).parentElement!!;

    //Adjust the y coordinate of the introduction bubbles
    const introductionBubble = document.querySelector<HTMLElement>(".introductionBubble");
    const introductionTip = document.querySelector<HTMLElement>(".tip");
